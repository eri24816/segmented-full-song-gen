...
def main(args):
    ...
    for i, song_info in enumerate(song_list):
        ...
        generated_song, annotations = generate(model, labels, lengths_in_bars, compose_order, seed_segment_pr, top_p=1)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--output_path", type=Path, default=Path("eval_results/midi/user_study"))
    arg_parser.add_argument(
