...
def generate(model:SegmentFullSongModel, labels: list[str], lengths_in_bars: list[int], compose_order: list[int], top_p: float = 1):
...
def main(args):
    ...
    for i, song_info in tqdm(enumerate(song_list)):
        ...
        generated_song, annotations = generate(model, labels, lengths_in_bars, compose_order, top_p=1)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--output_path", type=Path, default=Path("eval_results/midi/eval"))
    arg_parser.add_argument(
